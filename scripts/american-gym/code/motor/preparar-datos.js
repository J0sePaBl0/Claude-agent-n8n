...
// consulta, dos clientes conversando a la vez tumbaban la herramienta con un 429.
// Un batchGet de 8 rangos gasta 1.
const ORDEN = ['servicios', 'entrenadores', 'citas', 'feriados', 'config', 'clientes', 'oportunidades', 'actividades'];
